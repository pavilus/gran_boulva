...
// Battle imports — re-enable when Agora is configured
...
GoRouter createRouter() {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // ── Battle routes — commented out until Agora is configured ───────────
      // Re-enable by uncommenting these routes AND the imports at the top of this file.
      // GoRoute(path: '/battle/:id', builder: (_, s) => BattleScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/battle/:id/incoming', builder: (_, s) => BattleIncomingScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/battle/:id/lobby', builder: (_, s) => BattleLobbyScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/battle/:id/live', builder: (_, s) => BattleLiveScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/battle/:id/result', builder: (_, s) => BattleResultScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/battle/:id/replay', builder: (_, s) => BattleReplayScreen(battleId: s.pathParameters['id']!)),
      // GoRoute(path: '/challenge/:opponentId', builder: (_, s) => BattleChallengeScreen(opponentId: s.pathParameters['opponentId']!)),
    ],
  );
}
