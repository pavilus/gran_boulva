...
values
  ('top_voter', 'Top Votè', 'Top Voter', 'Vote sou matchups pou monte nivo ou.', 'Vote on matchups to level up.', 'assets/images/Topvotè.png', '#A855F7', 1),
  ('hot_streak', 'Tankou Dife', 'Hot Streak', 'Kenbe aktivite ou vivan chak jou.', 'Keep your participation streak alive.', 'assets/images/TankouDife.png', '#F97316', 2),
  ('debater', 'Gran Debatè', 'Debater', 'Ekri agiman ki fè diskisyon an pi rich.', 'Post arguments that strengthen the debate.', 'assets/images/Grandebatè.png', '#3B82F6', 3),
  ...
  ('community', 'Kominote', 'Community', 'Sipòte lòt moun epi fè kominote a grandi.', 'Support others and help the community grow.', 'assets/images/kominotè.png', '#D90C82', 5)
...
with thresholds(level, required_xp) as (
  values
    (1, 5),
    (2, 15),
    (3, 35),
